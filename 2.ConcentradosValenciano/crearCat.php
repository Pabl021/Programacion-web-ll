                ...
                <div class="col-md-5 contCC">
                    ...
                    <h3 class="text-center" style="color: #f7b178;">Tu tienda de alimentos de confianza ✔️</h3>
                      <form  method="POST" role="form">
                        <input id="inNombre"type="text" class="form-control" name="cat" placeholder="📝Categoría" autocomplete="off">
                        <a href=""><input type="button" value="Crear categoría" class="btn btn-primary"> </a>
