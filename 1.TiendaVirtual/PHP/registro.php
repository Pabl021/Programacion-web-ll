    ...
    <div class="row">
        <div class="col-md-3"></div>
            <div class="col-md-5">
                ...
                <p id="error" class="help is-danger"><?= $errors ?></p>
                ...
                <input id="inTel"type="tel" class="form-control" name="txttelefono" placeholder="📞 Teléfono" autocomplete="off">
